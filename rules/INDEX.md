...
## BACKOFFICE_DESIGN
- [BACKOFFICE_FRILO_MENUS_PAR_ROLE.md](BACKOFFICE_DESIGN/BACKOFFICE_FRILO_MENUS_PAR_ROLE.md) — Navigation par rôle (admin Filament / client / visiteur)
- [BACKOFFICE_FRILO_CRUDS_ET_FONCTIONNALITES.md](BACKOFFICE_DESIGN/BACKOFFICE_FRILO_CRUDS_ET_FONCTIONNALITES.md) — Opérations CRUD Filament par resource
