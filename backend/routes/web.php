...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'super_admin'])->group(function () {
    ...
    // Commandes
    Route::middleware('super_admin:ops_admin')->group(function () {
    ...
    Route::get('orders/{order}/receipt', [AdminOrderController::class, 'receipt'])
        ->middleware('super_admin:ops_admin,finance_admin')
        ->name('orders.receipt');

    // Paiements
    Route::middleware('super_admin:finance_admin')->group(function () {
        ...
        Route::patch('renewals/{order}/reminder', [AdminRenewalController::class, 'recordReminder'])->name('renewals.reminder');
        Route::patch('renewals/{order}/paid', [AdminRenewalController::class, 'markPaid'])->name('renewals.mark-paid');
    });
    ...
    Route::middleware('super_admin:super_admin')->group(function () {
    ...
    Route::get('audit-logs', [AdminAuditLogController::class, 'index'])
        ->middleware('super_admin:super_admin')
