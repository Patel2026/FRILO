...
var mapboxStyleUrl = 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}';
var mapboxAccessToken = (typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.VITE_MAPBOX_PUBLIC_TOKEN)
    ? import.meta.env.VITE_MAPBOX_PUBLIC_TOKEN
    : '';

function getMapboxTileUrl() {
    return mapboxAccessToken ? mapboxStyleUrl + '?access_token=' + mapboxAccessToken : mapboxStyleUrl;
}
